 ...
 * 
 * The square root model is the CEV process with elasticity factor \f$ \alpha = 1 \f$ for which the a 
...
#ifndef SQUARE_ROOT_CEV_HPP
#define SQUARE_ROOT_CEV_HPP
